...
1. Open all links in a new tab without any success. 
...
3. Decrypt SSL request by Wireshark. At the end does not work

_______________________


4. Decompile an application that refer me to repository those are not exists and suggest me to do some action manually, those are hard to do.

    At the end i solved my problem by search.
